...
def main():
    ...
    st.header("Research Assistant :book: ")    
    user_question = st.text_input("How can I help you with?")
    if user_question:
    ...
    with st.sidebar:
        ...
        if st.button("Process"):
            with st.spinner("Processing"):
                ...
                #change pdfs into multiple chuncks of texts
